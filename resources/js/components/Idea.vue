        ...
        <div class="well">
            ...
            <form action="" v-on:submit.prevent="createIdea">
                <div class="input-group">
                    <input type="text" name="" v-model="newIdea" class="form-control input-sm" maxlength="256" id="">
            ...
            <ul class="list-unstyled">
                <li v-for="idea in ideas">
                    <p><small class="text-muted"> <em>{{ since(idea.created_at) }}</em></small> {{ idea.description }}</p>
                </li>
            </ul>
        </div>
    </div>
